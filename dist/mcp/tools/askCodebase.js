...
export function askCodebase(context, raw) {
    return catchTool(async () => {
        ...
        return {
            ...common(input.max_tokens, [answer], symbols.slice(0, 3).map((s) => recommendSymbolContext(s.symbol)), symbols.length ? "medium" : "low", "Lexical retrieval over static index; local AI is optional and non-authoritative."),
            answer,
...
//# sourceMappingURL=askCodebase.js.map