...
export function getRelevantContext(context, raw) {
    return catchTool(() => {
        ...
        return {
            ...common(input.max_tokens, [answer], symbols.length
...
//# sourceMappingURL=getRelevantContext.js.map