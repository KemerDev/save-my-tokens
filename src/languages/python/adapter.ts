...
import type { ImportRecord, SourceFileText, SymbolRecord } from '../../indexer/types.js';
...
interface ScopeEntry { qualifiedName: string; indent: number; kind: 'class' | 'function' }
...
function extractDocstring(lines: string[], bodyStartIdx: number): string | null {
